...
count_vector = pk.load(open('/Users/vishnuleela/Downloads/cap/pickle_file/count_vector.pkl','rb'))            # Count Vectorizer
tfidf_transformer = pk.load(open('/Users/vishnuleela/Downloads/cap/pickle_file/tfidf_transformer.pkl','rb')) # TFIDF Transformer
model = pk.load(open('/Users/vishnuleela/Downloads/cap/pickle_file/model.pkl','rb'))                          # Classification Model
recommend_matrix = pk.load(open('/Users/vishnuleela/Downloads/cap/pickle_file/user_final_rating.pkl','rb'))   # User-User Recommendation System 
...
def recommend_products(user_name):
    recommend_matrix = pk.load(open('//Users/vishnuleela/Downloads/cap/pickle_file/user_final_rating.pkl','rb'))
